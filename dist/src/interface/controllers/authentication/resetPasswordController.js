...
const resetPassword_1 = require("../../../app/usecases/authentication/resetPassword");
...
const resetUserPasswordController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield (0, resetPassword_1.resetPassword)(userRepository)(identifier, password);
        if (user) {
