...
const postCourse_1 = require("../../../app/usecases/course/postCourse");
...
const postCourseController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isExist) {
            const course = yield (0, postCourse_1.postCourse)(courseRepository)(req.body);
            if (course) {
...
exports.default = postCourseController;
